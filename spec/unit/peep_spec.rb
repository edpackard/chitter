...
describe Peep do
  ...
  describe '.create' do
    it 'creates a new peep' do
      allow(PG).to receive(:connect).and_return(connection)
      allow(connection).to receive(:exec_params).with("INSERT INTO peeps (content, timestamp) VALUES ('a test', '2022-01-01 00:00:00 +0000') RETURNING id, content, timestamp").and_return([{"id"=>'1', "content"=>'Test pass', "timestamp"=>'2022-01-01 00:00:00 +0000'}])
